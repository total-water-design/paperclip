...
describe("sandbox callback bridge", () => {
  ...
  it("permits the documented heartbeat surface and denies unrelated routes", () => {
    const allowed: Array<{ method: string; path: string }> = [
      ...
      { method: "POST", path: "/api/issues/issue-1/attachment-transfers" },
      { method: "GET", path: "/api/issues/issue-1/attachment-transfers/transfer-1" },
      { method: "PUT", path: "/api/issues/issue-1/attachment-transfers/transfer-1/chunks/0" },
      { method: "POST", path: "/api/issues/issue-1/attachment-transfers/transfer-1/publish" },
