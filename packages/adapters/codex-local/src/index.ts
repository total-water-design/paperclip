...
- fatalTransportMaxReconnects (number | null, optional): after both the RMCP worker's fatal transport-channel-closed signature and the WebSocket proxy HTTP CONNECT 403 signature are observed on stderr, terminate after this many structured stdout "waiting for network" reconnect errors. Defaults to 3. Set to \`null\` to disable this monitor.
