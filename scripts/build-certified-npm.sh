...
mkdir -p "$stage/package/node_modules/@rollup/plugin-typescript"
tar -h -C "$repo_root" -cf - node_modules/@rollup/plugin-typescript | tar --strip-components=3 -C "$stage/package/node_modules/@rollup/plugin-typescript" -xf -
