...
if(String(snapshot.active_mode||snapshot.calculation_mode||'').toLowerCase()==='ccro'){window.__TOTALRO_CCRO_REPORT_SNAPSHOT__=snapshot;return;}
...
function projectBand(){
  ...
  return `<section class="section">${sectionTitle('1. Project and Design Basis','Populated project and design values')}<div class="info-grid">${items}</div></section>`;
}
